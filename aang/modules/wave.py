...
class Wave2Chunk(nn.Module):
    ...
    def __init__(self, **kwargs):
        ...
        pram_per_layer = [(11, 1, 0, 3), (11, 1, 0, 2), (2, 2, 0, 1),
        ...
        self.conv_block_1 = nn.Sequential(nn.Conv1d(1, self.config['b1'] // 2, 11, 1, dilation=3),  
                                          nn.ReLU(),
                                          nn.Conv1d(self.config['b1'] // 2, self.config['b1'], 11, 1, dilation=2),  
                                          nn.ReLU(),
                                          nn.MaxPool1d(2, 2),                   
